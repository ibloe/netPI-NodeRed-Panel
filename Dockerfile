...
# -------------------- Install Random nodes and all dependencies -----------------
 && npm install node-red-node-random@0.4.1 \
# -------------------- Install smooth nodes and all dependencies -----------------
 && npm install node-red-node-smooth@0.1.2 \ 
 # -------------------- Install CPU nodes and all dependencies -----------------
